 ...
 */
	Configure::write('Security.salt', '@#FroboBizphant#@');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */

	Configure::write('Security.cipherSeed', 'e76859309657453542496749683645');//76859309657453542496749683645
 ...
 */
 Configure::write('Hybridauth', array(
    "Facebook" => array(
        "enabled" => true,
        "keys" => array("id" => "1853985474818159", "secret" => "0b7ee7bd1c4e1ad353278b358915a7f2"),
        "scope" => "email"
    )
));