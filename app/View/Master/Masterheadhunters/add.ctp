<div class="x_panel">
	...
	<div class="x_content">
		<br />
		<?php
			echo $this->Form->create('SubHeadhunter', array(
				'type' => 'file',
		...
		<div class="form-group no-line " >
			...
			<div class="col-md-1 col-sm-1 col-xs-1">
				<?php
					echo $this->Form->label('representative_postion', 'Position', array(
		...
		<div class="form-group">
			...
			<div class="col-md-1 col-sm-1 col-xs-1">
				<?php
					echo $this->Form->label('representative_name', 'Name', array(
						'class' => 'control-label col-md-3 col-sm-3 col-xs-12'
					));
				?>
			</div>
		...
		<div class="form-group">
			<?php
				echo $this->Form->label('Establishment', 'Establishment', array(
					'class' => 'control-label col-md-3 col-sm-3 col-xs-12'
				));
			?>
			<div class="col-md-6 col-sm-6 col-xs-12" >
		...
		<div class="form-group">
			<?php
				echo $this->Form->label('business_overview', 'Business Overview', array(
					'class' => 'control-label col-md-3 col-sm-3 col-xs-12'
				));
			?>
			<div class="col-md-6 col-sm-6 col-xs-12">
		...
		<div class="form-group">
			<?php
				echo $this->Form->label('capital', 'Capital', array(
					'class' => 'control-label col-md-3 col-sm-3 col-xs-12'
				));
			?>
			<div class="col-md-1 col-sm-1 col-xs-1">
				<?php
					echo $this->Form->input('capital_type', array(
						'options' => array(
							1 => 'MMK',
							2 => 'USD'
						),
						'class' => 'control-label col-md-25 col-sm-25 col-xs-50 cptal_type'
					));
				?>
			</div>
			<div class="col-md-5 col-sm-5 col-xs-5">
				<span class="error">
					<?php
						echo $this->Form->input('capital', array(
							'type' => 'text',
							'label' => false,
							'class' => 'form-control col-md-7 col-xs-5 form-control',
							'autocomplete' => 'off',
							'placeholder' => '',
							'maxlength' => '15'
						));
			...
			<div class="col-md-3 col-sm-6 col-xs-12" style="margin-top: 1%;">
				<?php echo $this->Form->input('SubHeadhunter.capital_flag', array(
						'type' => 'checkbox',
						'label' => 'Hidden',
						'style' => 'margin-right: 3%;',
						'class' => 'company_check'
		...
		<div class="form-group">
			...
			<div class="col-md-3 col-sm-6 col-xs-12" style="margin-top: 1%;">
				<?php echo $this->Form->input('SubHeadhunter.number_of_employee_flag', array(
						'type' => 'checkbox',
						'label' => 'Hidden',
						'style' => 'margin-right: 3%;',
						'class' => 'company_check'
