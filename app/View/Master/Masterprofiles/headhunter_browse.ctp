<div class="x_panel">
	...
	<div class="x_content">
			...
			<tr>
				...
				<td class="right">
					<div class = "resize-img" style="width: 200px; height: 200px; border: thick solid lightgray; overflow: hidden; position: relative;">
						...
						<?php else : ?>
							<?php echo $this->Html->image('/img/common_img.jpg', array('alt' => 'story image', 'id' => 'previewHolder', "style" => "position: absolute;", "class" => "preview")); ?>
						<?php endif; ?>
					</div>
				</td>
			</tr>
		...
		<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4" style="margin-top: 1%;margin-bottom: -1%;">
			...
			<?php echo $this->Html->link('Edit', array('controller' => 'masterprofiles', 'action' => 'headhunterEdit', h($cmpdata['CmpHeadhunter']['id'])), array('class' =>'btn btn-orange btn-sm')); ?>
		</div>
	</div>
</div>
