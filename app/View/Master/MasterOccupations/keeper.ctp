				...
				<div class = "adjust">
					...
					<div class="col-md-10">
						<div class="search-box">
							<?php echo $this->Form->create('User', array('type' => 'get', 'url' => array('controller' => 'adminappliedjobseekers', 'action' => 'index'), 'class' => 'search-box-form', 'InputDefaults' => array('label' => false, 'div' => false))); ?>
								...
								<?php if( $cmpvalue['User']['deleted'] == false):?>
									<tr class="<?php if($cmpvalue['User']['withdraw'] == true) echo 'even'; ?>">
										...
										<td style="border:1px solid #ddd">
											<?php echo $this->Html->link('Browse', array('controller' => 'masteroccupations', 'action' => 'keeperBrowse', h($cmpvalue['OccupationFavorite']['user_id'])), array( 'class' => 'btn btn-blue btn-sm')); ?>
										</td>
