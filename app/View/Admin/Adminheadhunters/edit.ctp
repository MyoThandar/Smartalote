	...
	<div class="x_content">
		...
		<?php echo $this->Form->create('CmpHeadhunter', array('type' => 'file', 'class' => 'form-horizontal form-label-left', 'inputDefaults' => array('label' => false, 'div' => false), 'id' => 'demo-form2', 'autocomplete' => 'off')); ?>
			...
			<div class="form-group">
				<?php echo $this->Form->label('id', 'Headhunter ID', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php echo $this->Form->input('company_id', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' , 'placeholder' => '', 'disabled' => true, 'value' => $companyId)); ?>
				</div>
			</div>
			<div class="form-group">
				<?php
			...
			<div class="form-group" style="border-bottom: none; ">
				<?php echo $this->Form->label('phone_no', 'Phone Number', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
			...
			<div class="form-group">
				<?php echo $this->Form->label('Company_name', 'Company Name<span class="required">*</span>', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				<div class="col-md-3 col-sm-3 col-xs-6">
					<?php if (($company == 'empty' || $company == '') && !empty($this->request->data)) : ?>
						<?php
							echo $this->Form->input('company_name', array('type' => 'text','label' => false,'class' => 'form-control col-md-7 col-xs-12 test','id'=>'companyName','autocomplete' => 'off' ,'placeholder' => '','disabled' => true,'required' => false,'maxlength'=>'100'
							));
						?>
					<?php else : ?>
						<?php if ($cmp_data['CmpHeadhunter']['independents'] == 1) : ?>
							<?php echo $this->Form->input('company_name', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12 test','id'=>'companyName', 'autocomplete' => 'off' , 'placeholder' => '','disabled' => true,'required' => false,'maxlength'=>'100')); ?>
						<?php else: ?>
						<?php
			...
			<div class="form-group">
				...
				<span class=" error">
					<?php echo  $this->Form->input('region', array('type'=>'select', 'options'=>$location, 'label'=>false, 'class' => 'form-control ')); ?>
				</span>
				</div>
			</div>
			<div class="form-group">
				<?php echo $this->Form->label('logo', 'Photo <span class="required">*</span>
					...
					<?php else: ?>
						<div class = "resize-img" style="width: 200px; height: 200px; border: thick solid #666666; overflow: hidden; position: relative;">
							<?php if ($cmp_data['CmpHeadhunter']['logo']) : ?>
								<?php echo $this->Form->input('cologo',array('type' => 'hidden', 'label' => false,'value' => $cmp_data['CmpHeadhunter']['logo'])); ?>
								<?php echo $this->Html->image($cmp_data['CmpHeadhunter']['logo'], array('alt' => 'story image', 'id' => 'previewHolder', "style" => "position: absolute;", "class" => "preview")); ?>
							<?php else: ?>
			...
			<div class="form-group">
				<?php echo $this->Form->label('Education', 'Education<span class="required">*</span>
				', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php
					...
					<div class="col-md-2 col-sm-2 col-xs-2">
						<span class=" error">
							<?php echo $this->Form->input('HeadhunterOtherLanguage.'.$i.'.lang_skill', array(
								'type' => 'select',
								'options' => $headhunter_language_skill ,
								'label' => false,
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php if(!empty($about)):?>
						<?php echo $this->Form->input('about', array('type' => 'textarea', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' ,'value' => $about ,'placeholder' => '','maxlength'=>'300')); ?>
					<?php else :?>
			...
			<div class="form-group">
				...
				<?php if(!empty($profile)):?>
					<?php echo $this->Form->input('profile', array('type' => 'textarea', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' ,'value' => $profile, 'placeholder' => '','maxlength'=>'3000')); ?>
				<?php else :?>
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				<?php if(!empty($self_pr)):?>
					<?php echo $this->Form->input('self_pr', array('type' => 'textarea', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' , 'value' => $self_pr,'placeholder' => '','maxlength'=>'300')); ?>
					<?php else :?>
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<span class="error">
						<?php echo $this->Form->input('password_update', array('type' => 'password', 'label' => false, 'class' => 'form-control col-md-7 col-xs-5', 'autocomplete' => 'off' , 'placeholder' => '','maxlength'=>'20', 'minlength' => '8')); ?>
					</span>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
			...
			<div class="form-group no-line">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<span class="error">
						<?php echo $this->Form->input('confirm_password_update', array('type' => 'password', 'label' => false, 'class' => 'form-control col-md-7 col-xs-5', 'autocomplete' => 'off' , 'placeholder' => '','maxlength'=>'20', 'required' => false, 'minlength' => '8')); ?>
					</span>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
					<?php echo $this->Html->link('Cancel', array('type' => 'reset','controller' => 'adminheadhunters', 'action' => 'index'), array('onclick' => 'return confirm(" Do you want to cancel?")', 'class' => 'btn btn-gray btn-sm')); ?>
