		...
		<?php echo $this->Form->create('CmpHeadhunter', array('type' => 'file', 'class' => 'form-horizontal form-label-left', 'inputDefaults' => array('label' => false, 'div' => false), 'id' => 'demo-form2', 'autocomplete' => 'off')); ?>
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php echo $this->Form->input('id', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' , 'placeholder' => '','value' => $UserCode, 'disabled' => true)); ?>
				</div>
			</div>
			...
			<?php if (!empty($requestData)): ?>
				<?php foreach ($requestData['HeadhunterOtherLanguage'] as $key => $value) : ?>
					<div class="form-group" id=<?php if ($i == 0) echo "language"; ?> style="border-bottom: none;" >
					<?php echo $this->Form->label(' ', ' ', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				...
				<?php endforeach; ?>
			<?php else: ?>
				<div class="form-group" id="language" style="border-bottom: none;">
					<?php echo $this->Form->label(' ', ' ', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
					<div class="col-md-2 col-sm-2 col-xs-2 main_lang">
						<span class=" error">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php if(!empty($about)):?>
						<?php echo $this->Form->input('about', array('type' => 'textarea', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12 shout', 'autocomplete' => 'off' ,'value' => $about,'placeholder' => '','maxlength'=>'300')); ?>
					<?php else :?>
						<?php echo $this->Form->input('about', array('type' => 'textarea', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12 shout', 'autocomplete' => 'off' , 'placeholder' => '','maxlength'=>'300')); ?>
					<?php endif;?>
			...
			<div class="form-group">
				<?php echo $this->Form->label('password', 'Password <span class="required">*</span>', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<span class="error">
						<?php
							echo $this->Form->input('password', array(
								'type' => 'password',
								'label' => false,
								'class' => 'form-control col-md-7 col-xs-5', 'autocomplete' => 'off' ,
								'placeholder' => '',
								'maxlength'=>'20',
								'minlength' => '8',
								'id' => 'password',
			...
			<div class="form-group no-line">
				<?php echo $this->Form->label('confirm_password', 'Confirm Password	 <span class="required">*</span>', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<span class="error">
						<?php
...
<script type="text/javascript">
	...
	$(document).on('click', '#add-language', function(){
		...
		// the selected value of the last select box
		selected_select_clone = $('.lang_type').last().val();

		// Getting the select box to be added
		var last_select = language.find('select');

		// Removing the selected options of other select boxes
		$.each(last_select.children('option'), function(i, selectData) {
			if (selectData.value == selected_select_clone) {
				last_select.find('option[value='+selected_select_clone+']').remove();
			}
			if((selected_value.indexOf(selectData.value)) != -1) {
				last_select.find('option[value='+selected_value[selected_value.indexOf(selectData.value)]+']').remove();
				last_select.find('option[style="display: none;"]').attr('style', '/* display: none; */');
			}
		});
