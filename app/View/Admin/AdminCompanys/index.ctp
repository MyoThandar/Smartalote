			...
			<div class="x_content">
				<div class = "adjust">
					...
					<div class="col-md-10">
						...
						<div class="search-box sbox">
							<?php echo $this->Form->create('CmpHeadhunter', array('type' => 'get', 'url' => array('controller' => 'admincompanys', 'action' => 'index'), 'class' => 'search-box-form', 'InputDefaults' => array('label' => false, 'div' => false))); ?>
						...
						<?php echo $this->Html->link('Register', array('controller' => 'admincompanys', 'action' => 'add'), array('class' =>'btn btn-orange pull-right' ));
						?>
					</div>
				</div>
				...
				<?php if (!empty($pag)) : ?>
					<table class="table table-bordered">
						<thead>
							<tr>
								<th><?php echo $this->Paginator->sort('CmpHeadhunter.company_id', 'Company ID'); ?></th>
								<th><?php echo $this->Paginator->sort('CmpHeadhunter.company_name', 'Company Name'); ?></th>
								<th><?php echo $this->Paginator->sort('CmpHeadhunter.contact_name', 'Contact Person'); ?></th>
								<th><?php echo $this->Paginator->sort('CmpHeadhunter.company_phone', 'Phone'); ?></th>
								<th><?php echo $this->Paginator->sort('CmpHeadhunter.email', 'Email Address'); ?></th>
								...
								<tr class="<?php if($cmpvalue['CmpHeadhunter']['deactivate'] == true) echo 'even'; ?>">
									...
									<td>
										<?php if(!empty($cmpvalue['CmpHeadhunter']['company_name'])): ?>
											<?php if(strlen($cmpvalue['CmpHeadhunter']['company_name']) > 12): ?>
												<?php echo mb_substr($cmpvalue['CmpHeadhunter']['company_name'],0,12,'UTF-8')."..."; ?>
											<?php else: ?>
									...
									<td>
										<?php if(!empty($cmpvalue['CmpHeadhunter']['contact_name'])): ?>
											<?php if(strlen($cmpvalue['CmpHeadhunter']['contact_name']) > 14): ?>
												<?php echo mb_substr($cmpvalue['CmpHeadhunter']['contact_name'],0,14,'UTF-8')."..."; ?>
											<?php else: ?>
												<?php echo h($cmpvalue['CmpHeadhunter']['contact_name']); ?>
											<?php endif; ?>
										<?php endif; ?>
									</td>
									...
									<td>
										<?php if(!empty($cmpvalue['CmpHeadhunter']['company_phone'])): ?>
											<?php if(strlen($cmpvalue['CmpHeadhunter']['company_phone']) > 13): ?>
												<?php echo mb_substr($cmpvalue['CmpHeadhunter']['company_phone'],0,13,'UTF-8')."..."; ?>
											<?php else: ?>
												<?php echo h($cmpvalue['CmpHeadhunter']['company_phone']); ?>
											<?php endif; ?>
										<?php endif; ?>
									</td>
									...
									<td>
										<?php if(!empty($cmpvalue['CmpHeadhunter']['email'])): ?>
											<?php if(strlen($cmpvalue['CmpHeadhunter']['email']) > 12): ?>
												<?php echo mb_substr($cmpvalue['CmpHeadhunter']['email'],0,12,'UTF-8')."..."; ?>
											<?php else: ?>
												<?php echo h($cmpvalue['CmpHeadhunter']['email']); ?>
											<?php endif; ?>
										<?php endif; ?>
									</td>
									...
									<td>
										<?php echo $this->Html->link('Browse', array('controller' => 'admincompanys', 'action' => 'browse',h($cmpvalue['CmpHeadhunter']['id'])), array( 'class' => 'btn btn-blue btn-sm')); ?>

										<?php if ($cmpvalue['CmpHeadhunter']['deactivate'] == false): ?>
											<?php echo $this->Html->link('Deactivate', array('controller' => 'admincompanys', 'action' => 'approved', h($cmpvalue['CmpHeadhunter']['id'])), array('onclick' => 'return confirm(" Do you want to deactivate?")', 'class' => 'btn btn-gray btn-sm','style' => 'width:75px;')); ?>
										<?php elseif ($cmpvalue['CmpHeadhunter']['deactivate'] == true): ?>
											<?php echo $this->Html->link('Activate', array('controller' => 'admincompanys', 'action' => 'approved', h($cmpvalue['CmpHeadhunter']['id'])), array('onclick' => 'return confirm(" Do you want to activate?")', 'class' => 'btn btn-white btn-sm','style' => 'width:75px;')); ?>
										<?php endif; ?>

										<?php echo $this->Html->link('Delete', array('controller' => 'admincompanys', 'action' => 'delete', h($cmpvalue['CmpHeadhunter']['id'])), array('confirm' => "Would you like to delete this company?", 'class' =>'btn btn-royal-blue btn-sm')); ?>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
