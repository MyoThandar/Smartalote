...
<div class="x_panel">
	...
	<div class="x_content">
		...
		<?php echo $this->Form->create(
			'CmpHeadhunter',
			array('type' => 'file', 'class' => 'form-horizontal form-label-left', 'inputDefaults' => array('label' => false, 'div' => false), 'id' => 'demo-form2', 'autocomplete' => 'off')); ?>
			<div class="form-group">
				<?php echo $this->Form->label('id', 'Company ID', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php echo $this->Form->input('company_id', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' , 'placeholder' => '', 'disabled' => true,'value' => $cmpdata['CmpHeadhunter']['company_id'])); ?>
				</div>
			</div>
			<div class="form-group">
				<?php echo $this->Form->label('company_name', 'Company Name
						<span class="required">*</span>', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php echo $this->Form->input('company_name', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' , 'placeholder' => '','maxlength' => '100', 'id' => 'companyName', 'required' => false)); ?>
				</div>
			...
			<div class="form-group" style="border-bottom: none; ">
				...
				<div class="col-md-1 col-sm-1 col-xs-1">
					<?php echo $this->Form->label('company_phone', 'Main<span class="required">*</span>', array('class' => 'control-label col-md-3 col-sm-3 col-xs-5')); ?>
				</div>
				<div class="col-md-5 col-sm-5 col-xs-5">
					<span class=" error">
						<?php echo $this->Form->input('company_phone', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => '','maxlength' => '20', 'id' => 'phoneMain', 'required' => false)); ?>
					</span>
				</div>
			...
			<div class="col-md-3 col-sm-3 col-xs-3"></div>
				...
				<div class="col-md-5 col-sm-5 col-xs-5">
				<span class=" error">
					<?php echo $this->Form->input('mobile', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => '','maxlength' => '20')); ?>
				</span>
				</div>
			</div>
			<div class="form-group" style="border-bottom: none; ">
				<?php echo $this->Form->label('location', 'Address
						<span class="required">*</span>', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
				<div class="col-md-6 col-sm-6 col-xs-6">
					<?php echo $this->Form->input('location', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' , 'placeholder' => '','maxlength' => '100', 'id' => 'address', 'required' => false)); ?>
				</div>
			...
			<div class = "form-group">
				...
				<div class = "col-md-6 col-sm-6 col-xs-12">
					...
					<?php else : ?>
						<div class = "resize-img" style="width: 200px; height: 200px; border: thick solid #666666; overflow: hidden; position: relative;">
							<?php if ($cmpdata['CmpHeadhunter']['logo']) : ?>
								<?php echo $this->Form->input('cologo',array('type' => 'hidden', 'label' => false,'value' => $cmpdata['CmpHeadhunter']['logo'])); ?>
			...
			<div class="form-group">
				...
				<div class="col-md-5 col-sm-5 col-xs-5">
					<?php echo $this->Form->input('email', array('type' => 'email', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' , 'placeholder' => '','maxlength' => '60', 'id' => 'email','required' => false)); ?>
				</div>
