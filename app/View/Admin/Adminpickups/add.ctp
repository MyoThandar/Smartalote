	...
	<div class="x_content">
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<?php echo $this->Form->input('company_name', array('type' => 'text', 'label' => false, 'class' => 'form-control col-md-7 col-xs-12', 'autocomplete' => 'off' , 'placeholder' => '','maxlength'=>'100', 'id' => 'tags')); ?>
			</div>
		</div>
		<div class="form-group">
			...
			<div class='col-md-8'>
				...
				<div class="col-md-2">
					<div class='form-group'>
						<?php echo $this->Form->input('year', array('type'=>'select', 'options'=>$pick_year,'empty'=>'Year','class' => 'form-control select_height', 'label'=>false)); ?>
					</div>
				</div>
			</div>
		</div>
