				...
				<div class="mail-box">
					...
					<aside class="lg-side">
						...
						<div class="inbox-body">
							...
							<?php echo $this->Form->create('Sender', array('url' => array('controller' => 'adminmessages', 'action' => 'deleteAllTrashMessages'), 'id' => 'form', 'autocomplete' => 'off')); ?>
...
$(function(){
	$('.sender').click(function() {
		...
		var url = "<?php echo Router::url(array('controller' => 'adminmessages', 'action' => 'trashDetail')); ?>";
