				...
				<div class="mail-box">
					...
					<aside class="lg-side">
						...
						<div class="inbox-body">
							 ...
							 <?php echo $this->Form->create('Sender', array('url' => array('controller' => 'adminmessages', 'action' => 'deleteAllInboxMessages'), 'id' => 'form', 'autocomplete' => 'off')); ?>
...
$(document).ready(function() {
	...
	$('.delete-all-mess').css('pointer-events', 'none');
});
