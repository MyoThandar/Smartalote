							...
							<article>
								...
								<?php endif; ?>
									...
									<div class="col-md-12 col-sm-12 col-xs-12 none_padding" style="margin-left: -3%;line-height: 2.5em;">
										...
										<div class="col-md-8 col-sm-5 col-xs-5 word_break_rwo" style="margin:0px;padding:0px;">
											<?php if (!empty($userdata['User']['modified'])): ?>
											<?php echo date('d M Y', strtotime($userdata['User']['modified'])); ?>
										<?php endif; ?>
										</div>
									</div>
				...
				<body>
					<section style="border: none;">
						...
						<?php if (empty($user_instruction)) : ?>
							<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 1%;margin-left: 1%;margin-bottom: 1%;">
								No information
							</div>
						<?php else : ?>
							...
							<?php if (!empty($user_career)): ?>
								<?php foreach ($user_career as $key => $val): ?>
									<div class="career col-md-12 col-sm-12 col-xs-12 none_padding" style="margin-left: 2%;">
										...
										<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -2%;line-height: 2.5em;margin-left: 10px;margin-bottom: 1%;">
											<div class="col-md-11 txt-bold core-skill">
												<h3 class="career-hist-title" style="margin-top: 1%;font-size: 17px;margin-bottom: 0%;">Project</h3>
											</div>
													...
													<?php if (!empty($val['UserProject'])): ?>
														<?php foreach ($val['UserProject'] as $pkey => $pval) : ?>
															<div class="sub-project ">
																...
																<div class="col-md-12 pro-detail word_break_mobile">
								...
								<?php endforeach; ?>
							<?php else: ?>
								<div class="col-md-12 col-sm-12 col-xs-12 no-message"><br>
								...
								<section style="border: none;">
									...
									<div class="row">
										<?php if (!empty($user_edu)): ?>
											...
											<?php endforeach; ?>
										<?php else: ?>
											<div class="col-md-12 col-sm-12 col-xs-12 no-message">
												No information
											</div>
										<?php endif; ?>
									</div>
										...
										<?php if (!empty($user_qualification)): ?>
											<?php foreach ($user_qualification as $key => $val): ?>
												<div class="qualification" style="margin-left: 2%;">
													...
													<div class="col-md-12 col-sm-12 col-xs-12 none_padding" style="margin-top: -1%;margin-left: 1%;margin-bottom: -3%;">
														<div class="col-md-3 col-sm-5 col-xs-5 txt-bold">
															Date
														</div>
														<div class="col-sm-1 col-xs-1">
					...
					<section style="border: none;">
						...
						<div class="row">
							<?php if (!empty($user_computing)): ?>
								<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -3%;line-height: 2.5em;margin-left: 20px;">
									<div class="col-md-11 txt-bold core-skill">
								...
								<?php foreach ($user_computing as $key => $val): ?>
									<?php if ($key < 3): ?>
										<div class="computing" style="margin-left: 3%;">
											<div class="col-md-12 col-sm-12 col-xs-12 none_padding">
												<div class="col-md-3 col-sm-5 col-xs-5 txt-bold ">
								...
								<?php foreach ($user_computing as $key => $val): ?>
									<?php if ($key > 2) : ?>
										...
										<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -3%;line-height: 2.5em;margin-left: 20px;margin-bottom: 1%;">
											<div class="col-md-11 txt-bold core-skill">
												<h3 class="career-hist-title" style="margin-top: 3%;font-size: 17px;margin-bottom: 0%;">Others</h3>
											</div>
										</div>
