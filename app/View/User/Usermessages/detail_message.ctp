							...
							<div class="message-detail">
								<?php if (!empty($mgeDetails) || !empty($mgeReceiver)): ?>
									...
									<div class="row button-pl">
										...
										<div class="col-md-12">
											<?php echo $this->Html->link('Back', array('controller' => 'usermessages', 'action' => $action), array('class' => 'btn btn-default btn-sm')); ?>
											<?php if (!empty($mgeReceiver['Receiver']['id'])): ?>
												<a href="#myModal" data-toggle="modal" title="Compose"  class="btn btn-royal-blue btn-sm">
													Reply
												</a>
											<?php endif; ?>
										</div>
