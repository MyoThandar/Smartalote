		...
		<div id="container">
			...
			<div class="section">
				<div style="text-align: right">
					<?php $logo = "/var/www/html/app/webroot/img/jobvilla_pdf.png"; ?>
			...
			<div class="section">
				...
				<?php else : ?>
					<div class="personal-info" style="float:left;">
				<?php endif; ?>
					<h1>
				...
				<?php foreach ($data['UserCareerHistory'] as $key => $val): ?>
					<table>
						...
						<tbody>
							...
							<tr>
								<td class="thead">Joined</td>
								<td class="col">:</td>
								<td>
								<?php
									if (!empty($val['joined_y_m'])) {
										$data1 = explode('-', $val['joined_y_m']);
										$joined_y_m = $data['month'][(int)$data1[1]]. ' ' . $data1[0];
										echo $joined_y_m;
									}
								?>
								</td>
							...
							<tr>
								<td class="thead">Resignation</td>
								<td class="col">:</td>
								<td>
									<?php
									if (!empty($val['resignation'])) {
										$data2 = explode('-', $val['resignation']);
										$resignation = $data['month'][(int)$data2[1]]. ' ' . $data2[0];
										echo $resignation;
									}
								?>
								</td>
								...
								<td>
									<?php if (!empty($val['UserProject'])): ?>
										...
										<div class="row selection_education">
											<h4><?php echo $pval['title']; ?>&nbsp;&nbsp;<?php echo '('. $period_start .' &tilde; '. $period_end. ')'; ?> </h4>
											<br/>
											<p>
			...
			<div class="section gallery">
				...
				<?php foreach ($data['UserEducation'] as $key => $val): ?>
					<table>
						<tbody>
							<tr>
								<td class="thead">University name</td>
								<td class="col">:</td>
								<td>
