	...
	<?php echo $this->Form->create('User', array('type' => 'file', 'class' => ' form-horizontal', 'inputDefaults' => array('label' => false, 'div' => false), 'id' => 'contact_form', 'autocomplete' => 'off')); ?>
		...
		<div class="applyForm">
			<?php if (isset($requestData)) : ?>
				...
				<?php foreach ($requestData['UserEducation'] as $key => $value) : ?>
					<div id=<?php echo "apply_form[" . $key . "]";?> class='edu'>

						<div class="form-group">
							<div class="col-md-4 control-label cv_three_font letter_color" id="uni_title">University name</div>
							<div class="col-md-6 inputGroupContainer">
								<div class="input-group col-md-9 col-sm-6 col-xs-12">
									<?php
										echo $this->Form->input('UserEducation.' . $key . '.university_name', array(
											'type' => 'text',
											'id'=>'uni_id',
											'label' => false,
											'class' => 'form-control select_height',
											'autocomplete' => 'off' , 'placeholder' => 'e.g.) Yangon University of Foreign Language',
						...
						<div class="form-group">
							<p class="col-md-4 control-label cv_three_font letter_color" id="major_title">Department</p>
							<div class="col-md-6 selectContainer">
								<div class="input-group col-md-9 col-sm-6 col-xs-12">
									<?php
										echo $this->Form->input('UserEducation.' . $key . '.department', array(
											'type' => 'text',
											'id'=>'major_id',
											'label' => false,
											'class' => 'form-control select_height',
											'autocomplete' => 'off' , 'placeholder' => 'e.g.) Computer science department',
											'style' => 'border-color: #C0C0C0;border-radius:3px;width: 106%;'
										));
									?>
								</div>
						...
						<div class="form-group">
							<p class="col-md-4 control-label cv_three_font letter_color" id="de_title">Degree</p>
							<div class="col-md-6 selectContainer">
								<div class="input-group col-md-9 col-sm-6 col-xs-12">
									<i class=""></i>
									<?php
										echo $this->Form->input('UserEducation.' . $key . '.degree', array(
											'type' => 'select',
											'id' => 'de_id',
											'options' => $education,
											'empty' => 'Choose Level',
											'label' => false,
											'class' => 'form-control selectpicker select_height',
						...
						<div class="form-group">
							<p class="col-md-4 control-label cv_three_font letter_color" id="school_title">Enrollment</p>
							<div class="col-md-6 selectContainer">
									<div class="col-md-3 form-group">
										<?php
											echo $this->Form->input('UserEducation.' . $key . '.enroll_month', array(
												'type'=>'select',
												'id'=>'smonth',
												'options'=>$month,
												'empty'=>'Month',
									...
									<div class="col-md-3 form-group">
										<?php
											echo  $this->Form->input('UserEducation.' . $key . '.enroll_year', array(
												'type'=>'select',
												'id'=>'syear',
												'options'=>$year,
												'empty'=>'Year',
												'class' => 'form-control select_height',
												'label'=>false,'style'=>'border-radius:3px;width: 106%;'
											));
										?>
									</div>
							</div>
						...
						<div class="form-group graduation_main">
							<p class="col-md-4 control-label cv_three_font letter_color" id="school_title" >Graduation</p>
							<div class="col-md-6 selectContainer">
								<div class="col-md-3 form-group" id="edu">
									<?php
									echo $this->Form->input('UserEducation.' . $key . '.gd_month', array(
										'type'=>'select',
										'id'=>'smonth',
										'options' => $month,
										'empty'=>'Month',
										...
										'class' => 'form-control select_height',
										'style'=>'border-radius:3px;width: 106%;',
										'disabled' => isset($value['toggle']) ? $value['toggle'] : false
										));
										?>
									</div>
									<div class="col-md-1"></div>
									<div class="col-md-3 form-group">
										<?php
										echo $this->Form->input('UserEducation.' . $key . '.gd_year', array(
											'type'=>'select',
											'id'=>'syear',
											'options'=>$year,
											'empty'=>'Year',
							...
							<div class="col-md-6">
								<div class="input-group col-md-9 col-sm-6 col-xs-12">
								<?php
									echo $this->Form->input('UserEducation.' . $key . '.remarks', array(
										'type' => 'textarea',
										'label' => false,
										'class' => 'form-control',
										'autocomplete' => 'off' ,
			...
			<?php else : ?>
				<div id = "apply_form[0]" class="edu">
					<div class="form-group">
						<p class="col-md-4 control-label cv_three_font letter_color" id="uni_title">University name</p>
						<div class="col-md-6 inputGroupContainer">
							<div class="input-group col-md-9 col-sm-6 col-xs-12">
								<?php
									echo $this->Form->input('UserEducation.0.university_name', array(
										'type' => 'text',
										'id'=>'uni_id',
										'label' => false,
										'class' => 'form-control select_height',
										'autocomplete' => 'off',
										'placeholder' => 'e.g.) Yangon University of Foreign Language',
										'style' => 'border-color: #C0C0C0;border-radius:3px;width: 106%;'
									));
								?>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 selectContainer">
							<div class="input-group col-md-9 col-sm-6 col-xs-12">
								<?php
									echo $this->Form->input('UserEducation.0.department', array(
										'type' => 'text',
										'id'=>'major_id',
										'label' => false,
										'class' => 'form-control select_height',
					...
					<div class="form-group">
						...
						<div class="col-md-6 selectContainer">
							<div class="input-group col-md-9 col-sm-6 col-xs-12">
								<i class=""></i>
								<?php
									echo $this->Form->input('UserEducation.0.degree', array(
										'type'=>'select',
										'id'=>'de_id',
										'options'=>$education,
										'empty'=>'Choose Level',
					...
					<div class="form-group">
						...
						<div class="col-md-6 selectContainer">
								<div class="col-md-3 form-group">
									<?php
										echo $this->Form->input('UserEducation.0.enroll_month', array(
											'type'=>'select',
											'id'=>'smonth',
											'options'=>$month,
											'empty'=>'Month',
								...
								<div class="col-md-3 form-group">
									<?php
										echo $this->Form->input('UserEducation.0.enroll_year', array(
											'type'=>'select',
											'id'=>'syear',
											'options'=>$year,
											'empty'=>'Year',
					...
					<div class="form-group graduation_main">
						...
						<div class="col-md-6 selectContainer">
								<div class="col-md-3 form-group">
									<?php
										echo $this->Form->input('UserEducation.0.gd_month', array(
											'type'=>'select',
											'id'=>'smonth',
											'options' => $month,
											'empty'=>'Month',
								...
								<div class="col-md-3 form-group">
									<?php
										echo $this->Form->input('UserEducation.0.gd_year', array(
											'type'=>'select',
											'id'=>'syear',
											'options'=>$year,
											'empty'=>'Year',
								...
								<div class="col-md-5 still_checkbox" style="margin-top: 9px;">
									<?php echo $this->Form->input('Still in university', array(
										'type' => 'checkbox',
										'class'=>' col-md-2 toggleElement',
										'name' => "toggle",
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<div class="input-group col-md-9 col-sm-6 col-xs-12">
							<?php
								echo $this->Form->input('UserEducation.0.remarks', array(
									'type' => 'textarea',
									'label' => false,
									'class' => 'form-control',
									'autocomplete' => 'off' ,
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if ($('.error-message').length) {
			...
			// validateMessage.css('margin-top', '-10%');
