...
<head>
	...
	<?php echo $this->Html->script('tpl/main'); ?>
		...
		<nav class="navbar-default menu_design" >
			...
			<?php else:?>
				...
				<ul class="nav navbar-nav navbar-right sub_ul hidden-lg hidden-md">
					...
					<!-- <li>
					<a href="#FJseeker" style ='text-decoration:none;color:#fff'>About Us</a>
					</li> -->
				...
				<div class="col-md-12">
					<div class="col-md-6">
						<span class="logo "><!-- hidden-xs-->
							<?php echo $this->Html->link($this->Html->image("JobVilla-Footer.png",array('style' => 'margin-bottom: -7%;margin-top: -11%;')), array('controller' => 'usertpages', 'action' => 'index'), array('rel' => 'nofollow', 'escape' => false)); ?>
						</span>
						<table>
							<tr>
							...
							<tr>
									...
									<td>
										<?php  if(empty($user_id)):?>
											<p><?php echo $this->Html->link("Company's  Register", array('controller' => 'usertpages', 'action' => 'company_add'), array('class' => '','style' =>'text-decoration:none;color:#000')) ?><br></p>
											<p><?php echo $this->Html->link("Headhunter's  Register", array('controller' => 'usertpages', 'action' => 'headhunter_add'), array('class' => '','style' =>'text-decoration:none;color:#000')) ?><br></p>
										<?php  endif;?>
									</td>
